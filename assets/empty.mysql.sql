...
CREATE TABLE `oauth_tokens` (
  ...
  `username` varchar(256) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '' NOT NULL,
...
CREATE TABLE `token_requests` (
  ...
  `request_username` varchar(256) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '' NOT NULL,
