...
type TokenRequest struct {
	...
	RequestUsername      string       `json:"request_username"`       // request_username
...
func (tr *TokenRequest) Insert(ctx context.Context, db DB) error {
	...
	const sqlstr = `INSERT INTO oauth_proxy.token_requests (` +
		`app, request_grant_type, request_client_id, request_client_secret, request_username, request_refresh_token, request_code, request_redirect_url, request_code_verifier, response_access_token, response_token_type, response_refresh_token, response_expiry, response_extra, created_at, updated_at` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)`
	// run
	logf(sqlstr, tr.App, tr.RequestGrantType, tr.RequestClientID, tr.RequestClientSecret, tr.RequestUsername, tr.RequestRefreshToken, tr.RequestCode, tr.RequestRedirectURL, tr.RequestCodeVerifier, tr.ResponseAccessToken, tr.ResponseTokenType, tr.ResponseRefreshToken, tr.ResponseExpiry, tr.ResponseExtra, tr.CreatedAt, tr.UpdatedAt)
	res, err := db.ExecContext(ctx, sqlstr, tr.App, tr.RequestGrantType, tr.RequestClientID, tr.RequestClientSecret, tr.RequestUsername, tr.RequestRefreshToken, tr.RequestCode, tr.RequestRedirectURL, tr.RequestCodeVerifier, tr.ResponseAccessToken, tr.ResponseTokenType, tr.ResponseRefreshToken, tr.ResponseExpiry, tr.ResponseExtra, tr.CreatedAt, tr.UpdatedAt)
	if err != nil {
		return logerror(err)
	}
	// retrieve id
...
func (tr *TokenRequest) Update(ctx context.Context, db DB) error {
	...
	const sqlstr = `UPDATE oauth_proxy.token_requests SET ` +
		...
		`WHERE id = ?`
	// run
	logf(sqlstr, tr.App, tr.RequestGrantType, tr.RequestClientID, tr.RequestClientSecret, tr.RequestUsername, tr.RequestRefreshToken, tr.RequestCode, tr.RequestRedirectURL, tr.RequestCodeVerifier, tr.ResponseAccessToken, tr.ResponseTokenType, tr.ResponseRefreshToken, tr.ResponseExpiry, tr.ResponseExtra, tr.CreatedAt, tr.UpdatedAt, tr.ID)
...
func (tr *TokenRequest) Upsert(ctx context.Context, db DB) error {
	...
	// upsert
	const sqlstr = `INSERT INTO oauth_proxy.token_requests (` +
		`id, app, request_grant_type, request_client_id, request_client_secret, request_username, request_refresh_token, request_code, request_redirect_url, request_code_verifier, response_access_token, response_token_type, response_refresh_token, response_expiry, response_extra, created_at, updated_at` +
		`) VALUES (` +
		`?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?` +
		`)` +
		` ON DUPLICATE KEY UPDATE ` +
		`app = VALUES(app), request_grant_type = VALUES(request_grant_type), request_client_id = VALUES(request_client_id), request_client_secret = VALUES(request_client_secret), request_username = VALUES(request_username), request_refresh_token = VALUES(request_refresh_token), request_code = VALUES(request_code), request_redirect_url = VALUES(request_redirect_url), request_code_verifier = VALUES(request_code_verifier), response_access_token = VALUES(response_access_token), response_token_type = VALUES(response_token_type), response_refresh_token = VALUES(response_refresh_token), response_expiry = VALUES(response_expiry), response_extra = VALUES(response_extra), created_at = VALUES(created_at), updated_at = VALUES(updated_at)`
	// run
	logf(sqlstr, tr.ID, tr.App, tr.RequestGrantType, tr.RequestClientID, tr.RequestClientSecret, tr.RequestUsername, tr.RequestRefreshToken, tr.RequestCode, tr.RequestRedirectURL, tr.RequestCodeVerifier, tr.ResponseAccessToken, tr.ResponseTokenType, tr.ResponseRefreshToken, tr.ResponseExpiry, tr.ResponseExtra, tr.CreatedAt, tr.UpdatedAt)
	if _, err := db.ExecContext(ctx, sqlstr, tr.ID, tr.App, tr.RequestGrantType, tr.RequestClientID, tr.RequestClientSecret, tr.RequestUsername, tr.RequestRefreshToken, tr.RequestCode, tr.RequestRedirectURL, tr.RequestCodeVerifier, tr.ResponseAccessToken, tr.ResponseTokenType, tr.ResponseRefreshToken, tr.ResponseExpiry, tr.ResponseExtra, tr.CreatedAt, tr.UpdatedAt); err != nil {
		return logerror(err)
	}
	// set exists
	tr._exists = true
...
func TokenRequestByID(ctx context.Context, db DB, id int) (*TokenRequest, error) {
	...
	if err := db.QueryRowContext(ctx, sqlstr, id).Scan(&tr.ID, &tr.App, &tr.RequestGrantType, &tr.RequestClientID, &tr.RequestClientSecret, &tr.RequestUsername, &tr.RequestRefreshToken, &tr.RequestCode, &tr.RequestRedirectURL, &tr.RequestCodeVerifier, &tr.ResponseAccessToken, &tr.ResponseTokenType, &tr.ResponseRefreshToken, &tr.ResponseExpiry, &tr.ResponseExtra, &tr.CreatedAt, &tr.UpdatedAt); err != nil {
